# Generated by Django 5.0.9 on 2024-09-25 15:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery_images', to='wibekwa.articlepage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
