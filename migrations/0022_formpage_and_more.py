# Generated by Django 5.0.9 on 2024-09-23 23:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('wibekwa', '0021_remove_sitetemplatesettings_banner_image_width_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, default='50%', help_text='Styling for the banner image or if a single value, A css value representing the width of the banner image. Include at least one semicolon (;) to indicate that this is a style, and not just a width value', max_length=255),
        ),
        migrations.CreateModel(
            name='FormField',
            fields=[
